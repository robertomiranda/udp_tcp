 ...
 * @author roberto
 */
public class HelloMIDlet extends MIDlet implements CommandListener, observador.Observer {
...
//GEN-LINE:|4-resumeMIDlet|1|4-postAction
    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == form) {//GEN-BEGIN:|7-commandAction|1|19-preAction
            ...
            if (command == exitCommand1) {//GEN-END:|7-commandAction|5|29-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm());//GEN-LINE:|7-commandAction|6|29-postAction
                // write post-action user code here
    ...
    public TextField getTextField1() {
        if (textField1 == null) {//GEN-END:|23-getter|0|23-preInit
            // write pre-init user code here
            textField1 = new TextField("ip", "", 32, TextField.ANY);//GEN-LINE:|23-getter|1|23-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: form1 ">//GEN-BEGIN:|26-getter|0|26-preInit
    /**
     * Returns an initiliazed instance of form1 component.
     * @return the initialized component instance
     */
    public Form getForm1() {
        if (form1 == null) {//GEN-END:|26-getter|0|26-preInit
            // write pre-init user code here
            form1 = new Form("form1", new Item[] { getStringItem() });//GEN-BEGIN:|26-getter|1|26-postInit
            form1.addCommand(getExitCommand1());
            form1.setCommandListener(this);//GEN-END:|26-getter|1|26-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: stringItem ">//GEN-BEGIN:|31-getter|0|31-preInit
    /**
     * Returns an initiliazed instance of stringItem component.
     * @return the initialized component instance
     */
    public StringItem getStringItem() {
        if (stringItem == null) {//GEN-END:|31-getter|0|31-preInit
            // write pre-init user code here
            stringItem = new StringItem("Messages", null);//GEN-LINE:|31-getter|1|31-postInit
            // write post-init user code here
    ...
    public void update(Object msj) {
        stringItem.setText((String) msj);
    }
